...
- [express](https://expressjs.com/) - Ubiquitous Node framework
...
1. Install [Node](https://nodejs.com/) globally if you don't have it already
1. Fork repo
1. Using terminal change directories to the project root `cd /path/to/hugo-submodule`
1. Install dependencies by running `yarn`
1. Run any of the available commands found below
1. Go back up to main module, and run `docker-compose up`
